...
const FavesComponent = () => {
    ...
    const faves = route.params.userStore.saves;
    const fa = route.params.userStore
    // console.log(li);
    ...
    const filteredPosts = postsList.filter(item => faves.includes(item._id));

    return (
        <View style={{flex :1}}>
            <View style={{flex: 1, justifyContent: "center", alignItems: "center", alignContent: "center"}}>
                <Text style={{fontWeight: 'bold', fontSize: 24}}>Guardados</Text>
            </View>
